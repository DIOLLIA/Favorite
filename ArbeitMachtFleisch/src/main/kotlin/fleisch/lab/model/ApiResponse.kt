...
@Serializable
class ApiResponseCreated(override val data: Map<String, String>,
                            override val message: String,
                            val status: Int = HttpStatusCode.Created.value
) : ApiResponse()

@Serializable
class ApiResponseError(override val data: Map<String, String>?,
                          override val message: String,
                          val status: Int = HttpStatusCode.InternalServerError.value
    ) : ApiResponse()

@Serializable
class ApiResponseSuccess(override val data: Map<String, String>?,
                            override val message: String,
